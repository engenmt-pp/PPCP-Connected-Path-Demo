...
class PartnerMerchantConfig(TestingConfig):
    PARTNER_CLIENT_ID = os.environ.get("MERCHANT_CLIENT_ID")
    PARTNER_SECRET = os.environ.get("MERCHANT_SECRET")
    PARTNER_ID = os.environ.get("MERCHANT_ID")
    PARTNER_BN_CODE = 'TEST_BN_CODE'